...
client = MongoClient("mongodb://daniel:12345@cluster0-shard-00-00.z8w7k.mongodb.net:27017,cluster0-shard-00-01.z8w7k.mongodb.net:27017,cluster0-shard-00-02.z8w7k.mongodb.net:27017/?ssl=true&replicaSet=atlas-n66z9u-shard-0&authSource=admin&retryWrites=true&w=majority&appName=test") 
db = client['CRUD_DB']
...
def login():
    if request.method == "POST":
        ...
        if password == "12345" and username == "Juan":  # Cambia esto a la contraseña que desees
